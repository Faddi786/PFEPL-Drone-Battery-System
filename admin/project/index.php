                ...
                <div class="header-container text-center">
                    ...
                    <div class="btnAdd">
                        <a href="#!" data-id="" data-bs-toggle="modal" data-bs-target="#addUserModal"
                            class="btn btn-dark">Add Project</a>
                    </div>
                </div>
                <hr>
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="updateUser">
                        ...
                        <div class="mb-3 row">
                            <label for="project_id" class="col-md-3 form-label">project_id</label>
                            <div class="col-md-9">
            ...
            <div class="modal-content">
                ...
                <div class="modal-body">
                    <form id="addUser" action="">
                        <!-- <div class="mb-3 row">
                            <label for="addProjectID" class="col-md-3 form-label">project_id</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" id="addProjectID" name="project_id">
                            </div>
                        </div> -->
                        <div class="mb-3 row">
                            <label for="addProjectName" class="col-md-3 form-label">project_name</label>
                            <div class="col-md-9">
