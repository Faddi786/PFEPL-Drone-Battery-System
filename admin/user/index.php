...
<script type="text/javascript">
    ...
    $(document).on('submit', '#addUser', function (e) {
        ...
        var password = $('#addEmpPassword').val(); // Get the password field value
        ...
        if (emp_id !== '' && emp_name !== '' && password !== '') {
            $.ajax({
                ...
                data: {
                    emp_id: emp_id,
                    emp_name: emp_name,
                    password: password // Include password in data
                },
            ...
            <div class="modal-body">
                <form id="addUser" action="">
                    ...
                    <div class="mb-3 row">
                        ...
                        <div class="col-md-9">
                            <input type="password" class="form-control" id="addEmpPassword" name="password">
                        </div>
                    </div>
                    <div class="modal-footer">
                        <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
