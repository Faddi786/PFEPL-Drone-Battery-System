...
<?php include('../includes-admin/headers-admin.php');?>
                ...
                <div class="header-container text-center">
                    ...
                    <div class="btnAdd">
                        <a href="#!" data-id="" data-bs-toggle="modal" data-bs-target="#addUserModal"
                            class="btn btn-dark">Add Battery</a>
                    </div>
                </div>
                <hr>
    ...
    <script type="text/javascript">
        ...
        $(document).on('submit', '#addUser', function (e) {
            e.preventDefault();
            var battery_id = $('#addBatteryID').val();
            var battery_name = $('#addBatteryName').val();

            if (battery_id !== '' && battery_name !== '') {
                $.ajax({
                    url: "add_user.php",
                    type: "post",
                    data: {
        ...
        $('#example').on('click', '.editbtn', function (event) {
            ...
            $.ajax({
                ...
                success: function (response) {
                    $('#battery_id').val(response.battery_id); // Assuming response contains battery_id
                    $('#nameField').val(response.battery_name); // Populate name field
            ...
            if (confirm("Are you sure you want to delete this User?")) {
                $.ajax({
                    ...
                    success: function (data) {
                        ...
                        var status = json.status;
                        if (status == 'success') {
                            table.row($("#" + battery_id).closest('tr')).remove().draw();
                        } else {
        ...
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Update Battery</h5>
                ...
                <div class="modal-body">
                    <form id="updateUser">
                        ...
                        <div class="mb-3 row">
                            <label for="battery_id" class="col-md-3 form-label">battery_id</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" id="battery_id" name="battery_id" readonly>
                            </div>
                        </div>
    ...
    <div class="modal fade" id="addUserModal" tabindex="-1" aria-labelledby="exampleModalLabel" aria-hidden="true">
        <div class="modal-dialog">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel">Add Battery</h5>
                    <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                </div>
                <div class="modal-body">
                    <form id="addUser" action="">
                        <div class="mb-3 row">
                            <label for="addBatteryID" class="col-md-3 form-label">battery_id</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" id="addBatteryID" name="battery_id">
                            </div>
                        </div>
                        <div class="mb-3 row">
                            <label for="" class="col-md-3 form-label">battery_name</label>
                            <div class="col-md-9">
                                <input type="text" class="form-control" id="addBatteryName" name="battery_name">
                            </div>
                        </div>
                        <div class="modal-footer">
                            <button type="button" class="btn btn-secondary" data-bs-dismiss="modal">Close</button>
