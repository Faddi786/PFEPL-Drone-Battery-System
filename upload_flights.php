...
$username = "u221987201_root";
$password = "Flights_Root_01";
$dbname = "u221987201_flights";
...
foreach ($data as $flight) {
    ...
    $start_time = isset($flight['startTime']) ? formatDate($flight['startTime']) : null;
    ...
    $end_time = isset($flight['endTime']) ? formatDate($flight['endTime']) : null;
